...
class BestOffreProductSection extends StatefulWidget {
  const BestOffreProductSection({ Key? key }) : super(key: key);

  @override
  _BestOffreProductSection createState() => _BestOffreProductSection();
}

class _BestOffreProductSection extends State<BestOffreProductSection> {
